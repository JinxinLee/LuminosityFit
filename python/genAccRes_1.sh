...
for file in /lustre/miifs05/scratch/him-specf/paluma/jinxin/Lmddata/plab_1.50GeV/box_theta_*/*/*/*/*
do
path="${file}"
echo $path
...
mkdir ${path}/${recopath}
mkdir ${path}/${recopath4}
mkdir ${path}/${recopath1}
mkdir ${path}/${recopath2}
mkdir ${path}/${recopath3}
cp -r ../dataconfig_xy.json ${path}/${recopath}/dataconfig.json
cp -r ../dataconfig_xy.json ${path}/${recopath4}/dataconfig.json
cp -r ../dataconfig_xy.json ${path}/${recopath1}/dataconfig.json
cp -r ../dataconfig_xy.json ${path}/${recopath2}/dataconfig.json
cp -r ../dataconfig_xy.json ${path}/${recopath3}/dataconfig.json
done
